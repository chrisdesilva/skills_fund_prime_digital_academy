...
export const schoolInfo = {
  ...
  APRRange36: "11.42 - 11.50%",
  APRRange60: "12.76 - 12.80%",
  interestOnly: [
    {
...
export const leadContent = {
  ...
  paragraph: `${schoolName} offers programs in Full Stack Engineering and UX Design to prepare its students for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${
...
export const programLoanInfo = [
  // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SFPASE17",
    loanInfo: {
  ...
  {
    name: "UX Design",
    url: "https://my.skills.fund/application?lenderCode=SFPAUX17",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 21000,
      loanTerm36: true,
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $16,000 for UX Design or Full Stack Engineering tuition and up to $5,000 for cost of living."
